...
//                    System.out.println(Thread.currentThread().getName() + " Final Downloaded part from: " + startByte + " to " + endByte + " [real position("+ (startByte+1) +")]");   
//                    }
//                    else{
//                        System.err.println(Thread.currentThread().getName() + " Final Downloaded part from: " + startByte + " to " + endByte +"  [real position("+ (startByte+1) +")]");   
//                    }
                }
            } catch (IOException e) {
                e.printStackTrace();
